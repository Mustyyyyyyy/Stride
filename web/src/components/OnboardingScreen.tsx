  ...
  return (
     <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-10 relative overflow-hidden">
       <div className="absolute inset-0 pointer-events-none">
         ...
         <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-cyan-500/[0.05] blur-[100px]" />
       </div>

       <div className="relative z-10 w-full max-w-md space-y-8 animate-fadeIn">
         <div className="flex flex-col items-center text-center space-y-6">
           <div className="w-24 h-24 rounded-3xl bg-slate-900 border border-white/[0.06] flex items-center justify-center shadow-2xl shadow-black/40">
             {STEPS[step].icon}
           </div>
           ...
           <div className="w-full space-y-3 pt-2">
             <button
               ...
               className="w-full py-4 rounded-2xl bg-emerald-500 text-slate-950 font-extrabold text-base flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 hover:bg-emerald-400 transition-colors"
             >
